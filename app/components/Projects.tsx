  ...
  const projects = [
    {
      title: "Remind",
      description:
        "A full-stack web application that helps you organize valuable YouTube videos and personal thoughts in one centralized, distraction-free workspace.",
    ...
    },
    {
      title: "Miny",
      description:
        "A modern full-stack URL shortener that transforms long URLs into clean, shareable links. ",
      tags: ["React", "Drizzle", "PostgreSQL", "Express.js"],
    ...
    },
    {
      title: "Expenza",
      description:
        "A full-stack expense tracking web app to easily record, categorize, and analyze your daily spending.",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
          ...
          >
            ...
            <p className="text-4xl md:text-5xl font-bold tracking-tighter text-zinc-200">
              Featured{" "}
              <span className="text-zinc-600 font-castoro italic font-light lowercase">
                Works
              </span>
            </p>
          </motion.div>
          ...
          {projects.map((project, idx) => (
            ...
            >
                ...
                <div className="flex justify-between items-start mb-10 relative z-10">
                  ...
                  <div className="flex flex-wrap gap-2 justify-end">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[8px] uppercase font-black tracking-[0.2em] text-zinc-500 bg-white/5 border border-white/5 px-3 py-1 rounded-full"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              <div className="flex gap-6 mt-8 relative z-10 border-t border-white/5 pt-6">
                <a
                  href={project.github}
                  className="flex items-center gap-2 text-[10px] uppercase font-black tracking-[0.2em] text-zinc-500 hover:text-white transition-colors group/link"
                >
